...
class Utilities {
  ...
  bool comprobarDni(String dni) {
    ...
    if (contieneTexto(dni) &&
        dni.length == 9 &&
        esNumerico(dni.substring(0, 8)) &&
        LETRAS_DNI.elementAt((int.parse(dni.substring(0, 8)) % 23)) ==
            dni.substring(8).toUpperCase()) {
      valido = true;
    }
